...
import { idlFactory } from './secret.did.js';
export { idlFactory } from './secret.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SECRET_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./secret.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the secret canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./secret.did.js")._SERVICE>}
 */
export const secret = createActor(canisterId);
