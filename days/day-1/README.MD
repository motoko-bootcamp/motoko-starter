...
- Understand the concept of [cycles](../../manuals/chapters/chapter-1/CHAPTER-1.MD#fuel-on-the-internet-computer-cycles) & being able to top-up a **canister**.
- Understand the difference between [update](../../manuals/chapters/chapter-1/CHAPTER-1.MD#update-vs-query) & [query](../../manuals/chapters/chapter-1/CHAPTER-1#update-vs-query) calls.
- Understand the differences between a variable declared with [let](../../manuals/chapters/chapter-2/CHAPTER-2.MD#📦-variables) & [var](../../manuals/chapters/chapter-2/CHAPTER-2.MD#📦-variables).
